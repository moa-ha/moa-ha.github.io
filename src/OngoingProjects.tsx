      ...
      <div id="projects">
        <div className="projects">
          ...
          Node.js / Knex)
            ...
            <p>
              ✔️ Collaborating weekly with a teammate to develop a full-stack
              app, gaining deeper familiarity with previously used tools.
              <br></br>
              ✔️ Continuously learning and integrating new features, such as
              unit testing, which I hadn't focused on before.<br></br>
